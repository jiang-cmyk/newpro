...
public class meandevjob extends Configured implements Tool{
	...
	public static int work(String[] args) throws Exception {
		...
		return  ToolRunner.run(conf, new meandevjob(), args);
//		System.exit(run);
	}
	@Override
