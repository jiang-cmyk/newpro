...
import main.java.dataclean.mapper.mediamapper;
import main.java.dataclean.reduce.fzjgreducer;
import main.java.dataclean.reduce.mediareducer;


public class mediajob extends Configured implements Tool{
	...
	public static int work(String[] args) throws Exception {
		...
		return ToolRunner.run(conf, new mediajob(), args);
//		System.exit(run);
	}
	@Override
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(mediajob.class);
